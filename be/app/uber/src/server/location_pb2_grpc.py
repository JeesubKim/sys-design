...
class LocationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getUserLocation = channel.unary_unary(
                ...
                request_serializer=location__pb2.GetUserLocationRequest.SerializeToString,
                response_deserializer=location__pb2.Location.FromString,
                _registered_method=True)
        self.getDriverLocation = channel.unary_unary(
                '/location.LocationService/getDriverLocation',
                request_serializer=location__pb2.GetDriverLocationRequest.SerializeToString,
                response_deserializer=location__pb2.Location.FromString,
                _registered_method=True)
        self.updateLocation = channel.unary_unary(
                '/location.LocationService/updateLocation',
                request_serializer=location__pb2.UpdateLocationRequest.SerializeToString,
...
def add_LocationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getUserLocation': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=location__pb2.GetUserLocationRequest.FromString,
            ...
            'getDriverLocation': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=location__pb2.GetDriverLocationRequest.FromString,
                    response_serializer=location__pb2.Location.SerializeToString,
            ),
            'updateLocation': grpc.unary_unary_rpc_method_handler(
                    servicer.updateLocation,
                    request_deserializer=location__pb2.UpdateLocationRequest.FromString,
...
class LocationService(object):
    ...
    def getUserLocation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/location.LocationService/getUserLocation',
            location__pb2.GetUserLocationRequest.SerializeToString,
    ...
    def getDriverLocation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/location.LocationService/getDriverLocation',
            location__pb2.GetDriverLocationRequest.SerializeToString,
            location__pb2.Location.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def updateLocation(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/location.LocationService/updateLocation',
            location__pb2.UpdateLocationRequest.SerializeToString,
