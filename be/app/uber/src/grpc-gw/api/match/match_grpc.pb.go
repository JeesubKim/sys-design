...
const (
	MatchService_Estimate_FullMethodName    = "/match.MatchService/estimate"
	MatchService_Match_FullMethodName       = "/match.MatchService/match"
...
type MatchServiceClient interface {
	...
	Match(ctx context.Context, in *MatchRequest, opts ...grpc.CallOption) (*Match, error)
...
func (c *matchServiceClient) Estimate(ctx context.Context, in *EstimateRequest, opts ...grpc.CallOption) (*EstimateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EstimateResponse)
	err := c.cc.Invoke(ctx, MatchService_Estimate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *matchServiceClient) Match(ctx context.Context, in *MatchRequest, opts ...grpc.CallOption) (*Match, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Match)
...
func (UnimplementedMatchServiceServer) Estimate(context.Context, *EstimateRequest) (*EstimateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Estimate not implemented")
}
func (UnimplementedMatchServiceServer) Match(context.Context, *MatchRequest) (*Match, error) {
...
func _MatchService_Estimate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EstimateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MatchServiceServer).Estimate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MatchService_Estimate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MatchServiceServer).Estimate(ctx, req.(*EstimateRequest))
	}
...
var MatchService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "estimate",
			Handler:    _MatchService_Estimate_Handler,
		},
		{
			MethodName: "match",
